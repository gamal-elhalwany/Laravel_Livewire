            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-lg border-0 rounded-lg glow-effect">
                    <div class="card-header bg-gradient-primary-to-secondary text-white">
                        <h3 class="text-center mb-0">Update The Post</h3>
                    </div>

                    <div class="card-body p-5">
                        <!-- Start Creation Form -->
                        <form wire:submit.prevent="update" enctype="multipart/form-data">
                            <div class="mb-4" style="height: 400px; background: url('{{ asset('storage/'.$post->image) }}') no-repeat center/cover;">
                            ...
                            <div class="mb-4">
                                ...
                                <!-- <label class="form-lable fw-bold text-primary">Old Post Image</label>
                                <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->title }}" style="height:50px;width:50px;border:1px solid; border-radius:5px;padding:2px;margin-top:10px;"> -->
                                @error('image')
                                <div class="invalid-feedback animated fadeIn">
                                    <i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                </div>
                            ...
                            <div class="d-grid mt-5">
                                <button type="submit" class="btn btn-primary btn-lg btn-glow" wire:click="update" wire:navigate>
                                    <i class="fas fa-save me-2"></i> Update The Post
                                </button>
                            </div>
                        </form>
                        <!-- End Creation Form -->
