            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('post.create') }}" class="btn btn-light" wire:navigate>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate" style="max-width: 200px;">
                                        <a href="{{ route('post.show', $post->id) }}" wire:navigate>
                                            {{$post->title}}
                                        </a>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('post.show', $post->id) }}" class="btn btn-sm btn-outline-primary" wire:navigate>
                                            <i class="fas fa-edit"></i> Edit
                                        </a>

                                        <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure?')" wire:click="delete({{ $post->id }})">
